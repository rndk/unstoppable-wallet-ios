...
class SendSuiService {
  let sendToken: Token
  let mode: SendBaseService.Mode
  
  private let disposeBag = DisposeBag()
  private let adapter: SuiAdapter
...
extension SendSuiService: IAvailableBalanceService {
...
extension SendSuiService: IAmountInputService {
...
extension SendSuiService {
  ...
  struct SendData {
    let addressData: SendSuiService.AddressData
