...
public class BIP39 {
  ...
  public static func generateMnemonics(
    bitsOfEntropy: Int,
  ...
  static func generateChecksum(
    entropyBytes inputData: Data,
    checksumLength: Int
  ) -> String? {
  ...
  public static func generateMnemonicsFromEntropy(
    entropy: Data,
    language: BIP39Language = .english
  ) -> String? {
  ...
  public static func generateMnemonicsFrom(
    entropy: Data,
    language: BIP39Language = .english
  ) -> [String] {
  ...
  public static func mnemonicsToEntropy(
    _ mnemonics: String,
    language: BIP39Language = .english
  ) -> Data? {
  ...
  public static func mnemonicsToEntropy(
    ...
    let checksum = String(
      entropy.sha256().bitsInRange(0, checksumBits.count)!,
      radix: 2
  ...
  public static func seedFromMmemonics(
    _ mnemonics: [String],
    password: String = "",
    language: BIP39Language = .english
  ) -> Data? {
  ...
  private static func dataFrom(
    ...
    guard let seedArray = try? PKCS5.PBKDF2(
      password: mnemData.bytes,
      salt: saltData.bytes,
      iterations: 2048,
      keyLength: 64,
  ...
  public static func seedFromEntropy(
    _ entropy: Data,
    password: String = "",
    language: BIP39Language = .english
  ) -> Data? {
