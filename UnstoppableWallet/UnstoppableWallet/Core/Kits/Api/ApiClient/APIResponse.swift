...
public protocol APIClientResponse: Decodable {
    ...
    var error: DerivableResponseError? { get }
}
...
public struct AnyResponse<Entity: Decodable>: APIClientResponse {
    ...
    public var error: DerivableResponseError?
    ...
    public init(from decoder: Decoder) throws {
        ...
        error = try container.decodeIfPresent(DerivableResponseError.self, forKey: .error)
    }
...
public struct JSONRPCResponse<Entity: Decodable>: APIClientResponse {
    ...
    public init(id: String? = nil, result: Entity? = nil, error: DerivableResponseError? = nil, method: String? = nil) {
        jsonrpc = "2.0"
        self.id = id ?? ""
        self.result = result
        self.error = error
