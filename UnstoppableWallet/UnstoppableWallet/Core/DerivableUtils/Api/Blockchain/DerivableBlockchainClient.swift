...
public protocol DerivableBlockchainClient: AnyObject {
    /// APIClient for handling network requests
    var apiClient: JSONRPCAPIClient { get set }
    ...
    func sendTransaction(
        preparedTransaction: DerivablePreparedTransaction
    ) async throws -> String
...
public extension DerivableBlockchainClient {
