...
public protocol DerivationApiClient {
    /// The endpoint that indicates the rpcpool address and network
//    var endpoint: APIEndPoint { get } //TODO
    ...
    ///
    func getBlockCommitment(block: UInt64) async throws -> DerivableBlockCommitment
    ...
    ///
    func getClusterNodes() async throws -> [DerivableClusterNodes]
    ...
    ///
    func getConfirmedBlock(slot: UInt64, encoding: String) async throws -> DerivableConfirmedBlock
    ...
    ///
    func getEpochInfo(commitment: Commitment?) async throws -> DerivableEpochInfo
    ...
    ///
    func getFees(commitment: Commitment?) async throws -> DerivableFee
    ...
    ///
    func getSignatureStatuses(signatures: [String], configs: RequestConfiguration?) async throws -> [DerivableSignatureStatus?]
    /// - SeeAlso getSignatureStatuses(signatures: , configs:) async throws -> [SignatureStatus?]
    func getSignatureStatus(signature: String, configs: RequestConfiguration?) async throws -> DerivableSignatureStatus
    ...
    ///
    func getTokenAccountBalance(pubkey: String, commitment: Commitment?) async throws -> DerivableTokenAccountBalance
    ...
    ///
    func getTokenLargestAccounts(pubkey: String, commitment: Commitment?) async throws -> [DerivableTokenAmount]
    ...
    ///
    func getTokenSupply(pubkey: String, commitment: Commitment?) async throws -> DerivableTokenAmount
    ...
    ///
    func getVersion() async throws -> DerivableVersion
    ...
    ///
    func getVoteAccounts(commitment: Commitment?) async throws -> DerivableVoteAccounts
    ...
    ///
    func simulateTransaction(transaction: String, configs: RequestConfiguration) async throws -> DerivableSimulationResult
...
//    func observeSignatureStatus(signature: String, timeout: Int, delay: Int) -> AsyncStream<PendingTransactionStatus>
    ...
    /// - SeeAlso https://docs.solana.com/developing/clients/jsonrpc-api#getrecentblockhash
    ///
    func getSignaturesForAddress(address: String, configs: RequestConfiguration?) async throws -> [DerivableSignatureInfo]
    ...
    /// - Returns:
    /// - Throws:
    func getTransaction(signature: String, commitment: Commitment?) async throws -> DerivableTransactionInfo?
...
//        -> [AnyResponse<JSONRPCRequestEncoder.RequestType.Entity>]
    ...
    ///
    func getRecentPerformanceSamples(limit: [UInt]) async throws -> [DerivablePerfomanceSamples]
