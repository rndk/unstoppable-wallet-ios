...
public struct DerivableCompiledInstruction: Equatable {
...
extension Sequence where Iterator.Element == TransactionInstruction {
    func compile(accountKeys: [PublicKey]) -> [DerivableCompiledInstruction] {
        var compiledInstructions = [DerivableCompiledInstruction]()
        ...
        for instruction in self {
            ...
            let compiledInstruction = DerivableCompiledInstruction(
