...
public typealias DerivableBlockHash = String

/// Lecagy message
public struct DerivableMessage: IMessage, Equatable {
  public var version: DerivableTransactionVersion { .legacy }
  ...
  public internal(set) var header: DerivableMessageHeader
  public internal(set) var accountKeys: [PublicKey]
  public internal(set) var recentBlockhash: DerivableBlockHash
  public internal(set) var instructions: [DerivableCompiledInstruction]
  public var staticAccountKeys: [PublicKey] { accountKeys }
  
  init(header: DerivableMessageHeader, accountKeys: [PublicKey], recentBlockhash: DerivableBlockHash,
       instructions: [DerivableCompiledInstruction])
  {
    self.header = header
  ...
  static func from(data: Data) throws -> DerivableMessage {
    var data = data
    ...
    var instructions: [DerivableCompiledInstruction] = []
